...
## GET /document/{doc_id}  (v2, позже)
Для перехода к документу по клику на источник или узел Publication.
```json
{ "doc_id": "ni_ew_ru", "title": "…", "year": 2023, "source_path": "…", "text": "полный текст" }
```
