...
_DOC_TEXT = ("На Надеждинском металлургическом заводе применяется электроэкстракция никеля "
...
DOC = {"doc_id": "ni_ew_ru", "title": "Электроэкстракция никеля (отеч. опыт)", "year": 2023,
       "lang": "ru", "source_path": "sample/ni_ew_ru.txt", "text": _DOC_TEXT,
       "mentions": link_nodes_in_answer(_DOC_TEXT, ASK["graph"]["nodes"])}
